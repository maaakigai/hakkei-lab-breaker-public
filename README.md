...
[![展示機とスマートフォンに同じ結果を表示するデモ](docs/images/smartphone-result.jpg)](docs/media/smartphone-demo.mp4)

▶ [68秒のスマートフォン連携デモを再生する](docs/media/smartphone-demo.mp4)

展示機とスマートフォンの画面を並べ、QR登録から準備、チャージ、破壊映像、結果共有、ランキング、再登録までをまとめた操作デモです。スマートフォン中心の操作導線と、両画面の進行・結果の連携を確認できます。2026年9月に提出用として提供された編集済み動画を、閲覧用の1280×720に圧縮しています。音声トラックはありません。

映像は画面操作と連携の説明用で、センサーを装着した身体動作や展示会場は映っていません。展示実績は[展示ログに基づく別資料](docs/EXHIBITION_EVIDENCE.md)をご覧ください。

<details>
<summary>キーボード予備入力による画面遷移参考デモを見る</summary>
