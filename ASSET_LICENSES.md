...
`docs/media/smartphone-demo.mp4`は、2026年9月に提出用として提供された、展示機とスマートフォンの画面を並べた68秒の編集済み操作デモです。元ファイル`Timeline 1.mp4`（1920×1080）を1280×720に圧縮し、映像ストリームだけを収録しています。`docs/images/smartphone-result.jpg`は同動画の39秒付近から切り出した静止画です。デモにはゲーム内のAI生成の破壊映像も映りますが、デモ全体をAI生成したものではありません。
